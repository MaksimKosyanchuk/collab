	...
	return (
		<div className="space-y-2 border-t border-line pt-3">
			<div className="flex items-center justify-between gap-2">
				<p className="text-[11px] uppercase tracking-wide text-muted">History</p>
				<button
					type="button"
			...
			{!loading && versions.length === 0 ? <p className="empty">No versions yet</p> : null}
			<ul className="max-h-48 space-y-1.5 overflow-y-auto">
				{versions.map((version) => (
					<li key={version.id} className="rounded-md border border-line px-2 py-1.5">
