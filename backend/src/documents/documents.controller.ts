...
export class DocumentsController {
	...
	respondShareInvite(@CurrentUser() user: AuthUser, @Body() dto: RespondDocumentShareDto) {
	...
	tree(@CurrentUser() user: AuthUser, @Param('workspaceId') workspaceId: string) {
	...
	@ApiParam({ name: 'documentId', description: 'Document ID' })
	listVersions(@CurrentUser() user: AuthUser, @Param('documentId') documentId: string) {
	...
	@ApiParam({ name: 'documentId', description: 'Document ID' })
	snapshot(@CurrentUser() user: AuthUser, @Param('documentId') documentId: string) {
